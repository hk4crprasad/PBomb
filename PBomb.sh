...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing PBomb'
    else
        figlet PBomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mHk4crprasad \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Hk4crprasad
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/PBombChat \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/Hk4crprasadTech \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of PBomb for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Hk4crprasad > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN PBomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
